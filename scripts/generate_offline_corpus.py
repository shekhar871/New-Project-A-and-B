    ...
    with out_path.open("w", encoding="utf-8") as f:
        for task in (
            ...
            for i in range(per_task):
                ...
                if is_benign:
                    # benign record: still stored in same fields for training prompts
                    record = {
                        "task": task.value,
                        "attack_text": {
                            "prompt_injection": "Summarize this short paragraph about climate change.",
                            "tool_misuse_ssrf": "https://api.github.com/repos/huggingface/transformers",
                            "memory_poisoning": "The meeting is scheduled for Tuesday at 3pm in room 204.",
                        }[task.value],
                        "attack_type": "benign",
